...
st.markdown("""
    <style>
        ...
        /* --- MOBILE GRID FIX --- */
        /* This targets columns INSIDE other columns (Nested Columns) */
        /* It forces them to be 33% width even on mobile */
...
with col_l:
    ...
    # --- 3x3 GRID (0-7 and 8+) ---
    # We use st.columns(3) three times. 
    # The CSS [data-testid="column"] [data-testid="column"] rule forces these to stay 33% wide on mobile.
